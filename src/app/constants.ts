...
export const aws_service_contactform = "https://m9iark1b8g.execute-api.us-east-1.amazonaws.com";

//social media links
export const instagram = 'https://www.instagram.com/tourmond_adventures/';
export const facebook = 'https://www.facebook.com/tourmond.travelclub.9';
export const skype = 'tourmond_usa';